...
from .views import login,home,signup,signup_mobile,login_with_mobile,group,create_transaction,create_group_example,settle_up,del_transaction
...
urlpatterns = [
    ...
    path('transaction_delete', group.del_transaction, name='transaction_delete'),
]
